...
func TestApplicationEveryUsageIssueBypassesDependenciesAndStdin(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "missing subcommand", arguments: []string{"ai4j", "plan"}, issue: cli.UsageMissingSubcommand},
		{name: "unknown subcommand", arguments: []string{"ai4j", "plan", "secret-subcommand"}, issue: cli.UsageUnknownSubcommand, forbidden: "secret-subcommand"},
